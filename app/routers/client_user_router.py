...
from app.repositories.client_user_repository import ALGORITHM, SECRET_KEY, ClientUsersRepository, create_access_token, send_sms
...
def get_current_user(token: str = Depends(oauth2_scheme)) -> int:
    try:
        ...
        client_user_id: int = payload.get("sub")
